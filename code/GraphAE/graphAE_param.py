...
class Parameters():
    ...
    def read_config(self, fn):
        ...
        self.pcs_train_X = config.get("Params", "pcs_train_X")
        self.pcs_train_Y = config.get("Params", "pcs_train_Y")
        # self.pcs_evaluate = config.get("Params", "pcs_evaluate")
        self.pcs_evaluate_X = config.get("Params", "pcs_evaluate_X")
        self.pcs_evaluate_Y = config.get("Params", "pcs_evaluate_Y")
        self.pcs_evaluate_faces = config.get("Params", "pcs_evaluate_faces")
